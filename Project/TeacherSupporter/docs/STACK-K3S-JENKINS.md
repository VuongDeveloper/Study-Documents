...
| **Databases** | Postgres ×2, MongoDB, Garage (S3; replaced MinIO, see MIGRATION-GARAGE.md) — images + PVCs | run as arbitrary UID → OpenShift-portable |
...
[ GitHub ]──push──>[ Jenkins (Docker on ts-server) ]
                          ...
                          [ k3s ]  Deployments · Services · Ingress · PVCs
                                   Strimzi Kafka · Postgres ×2 · Mongo · Garage
                                     │
...
| Postgres ×2, Mongo, Garage | 1.3 GB |
