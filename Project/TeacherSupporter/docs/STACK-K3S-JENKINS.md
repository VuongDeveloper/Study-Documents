...
| **Databases** | Postgres ×2, MongoDB, Alarik (S3) — pinned images + PVCs | run as arbitrary UID → OpenShift-portable |
...
[ GitHub ]──push──>[ Jenkins (Docker on ts-server) ]
                          ...
                          [ k3s ]  Deployments · Services · Ingress · PVCs
                                   Strimzi Kafka · Postgres ×2 · Mongo · Alarik
                                     │
...
| Postgres ×2, Mongo, Alarik | 1.5 GB |
