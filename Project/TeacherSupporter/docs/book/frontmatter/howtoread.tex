...
\begin{description}
  ...
  \item[Deep dives push a design until it breaks.] Part~VIII revisits
  one technology per chapter and asks the questions the main chapters
  postpone: why this choice, what it solves, what it costs, what breaks
  at 3\,a.m., and what the concrete upgrade looks like --- with complete
  code, not sketches. Read them after the corresponding main chapter, or
  before an interview.
\end{description}
