...
Chapter~27 discusses when they earn their complexity.
...
same validation, different key ceremony. Chapter~28 takes this design
apart under load: where verification belongs, what asymmetric keys
change, and how to keep tokens thin.
