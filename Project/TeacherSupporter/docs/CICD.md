...
Today you have **no integration tests that need Postgres/Kafka/Alarik**, so `mvn verify`
...
## 4. When your tests need infrastructure (Postgres, Kafka, Alarik)
